...
| 🧭 Jira | Natural-language Jira assistant (v1.0.4) for viewing, creating, and updating issues, supporting CLI and MCP backends; always sets a time estimate on the native Original Estimate field (AI Estimate + human review estimate, the latter using a project multiplier remembered in `.agents/contexts/jira/MEMORY.md`, defaulting to `1`), never in the description. (Forked from https://github.com/davila7/claude-code-templates/cli-tool/components/skills/ai-research/jira) | [jira/SKILL.md](jira/SKILL.md) | `npx skills add https://github.com/bondansebastian/agent-skills --skill jira` |
